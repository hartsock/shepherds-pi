---
name: concision
description: "One editing pass for outward writing. Decompose into publishable atoms, compress with Williams and Lanham, then strip the patterns readers flag as machine-written. Hard bans on em dash, emoji, and Tier-1 AI vocabulary. Bundled tool: ai-tells."
---
...
```bash
tools/ai-tells DRAFT.md              # report
tools/ai-tells DRAFT.md --hard       # exit 1 on any hard ban
tools/ai-tells DRAFT.md --json
```
