...
The remaining skills (`tdd-red-green-blue`, `functional-cohesion`,
`three-cs`, `unix-philosophy`, `concision`) are working-style doctrine, not
setup steps — apply them whenever they're relevant to the task at hand,
